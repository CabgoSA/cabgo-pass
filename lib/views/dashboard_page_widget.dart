            ...
            children: <Widget>[
                ...
                return SizedBox(
                  ...
                  child: GoogleMap(
                    initialCameraPosition: CameraPosition(
                        target: appState.initialPosition, zoom: 13),
                              ...
                              return Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Visibility(
                                        visible:
                                            appState.topContainerVisibility,
                                        child: Padding(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    IconButton(
                                                      onPressed: () {
                                                        appState.dragableHeight =
                                                            0.2;
                                                        appState.bottomContainerVisibility =
                                                            !appState
                                                                .bottomContainerVisibility;
                                                        appState.topContainerVisibility =
                                                            !appState
                                                                .topContainerVisibility;
                                                        setState(() {});
                                                      },
                                                      icon: Icon(
                                                        Icons.close,
                                              ...
                                              Padding(
                                                ...
                                                child: TextField(
                                                  ...
                                                  controller:
                                                      appState.startController,
                                                  autofocus: false,
                                                  focusNode:
                                                      appState.startFocusNode,
              ...
              Visibility(
                visible: (appState.dragableTwoVibility &&
                    appState.rideNotification == null),
                child: DraggableScrollableSheet(
                                        ...
                                        onRated: (value) async {
                                          try {
                                            ...
                                            ScaffoldMessenger.of(context)
                                                .showSnackBar(
                                              appState.SnackBarCaller(
                                                  "There was a problem in rating ride!"),
                                            );
                                          }
                                        },
                                      )),
...
//bottomsheet start
  void _bottomSheetMore(
      context, appState, double distance, ProgressDialog loading) {
      ...
      InkWell(
        onTap: () async {
          try {
            ...
            if (result) {
              setState(() {
  if (appState.selectedService == service['id']) {
    appState.currentColor = Colors.blue;
  } else {
    appState.currentColor = Colors.white;
  }
});
        ...
        child: Padding(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: (appState.selectedService == service['id'])
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'R' + (appState.dp(distance * double.parse(service['price']), 3)).toString(),
...
,
              ...
              SizedBox(
                ...
                child: TextButton(
                  ...
                  style: ButtonStyle(
                      backgroundColor:
                          MaterialStateProperty.all(Color(0xFF169F49))),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'R' +
                          (appState.dp(double.parse(appState.estimatePrice), 3))
                              .toString(),
                      style: TextStyle(
                        fontFamily: 'Red Hat Display',
                        fontSize: 18,
